...
#https: // developers.synopticdata.com/about/station-variables/
 ...
 # Here we'll show how to create the url manually 
 # You can also use this tool to do it: #https: // developers.synopticdata.com/mesonet/explorer/
...
# The complete format of this dictionary is descibed here: 
# https://developers.synopticdata.com/mesonet/v2/getting-started/
