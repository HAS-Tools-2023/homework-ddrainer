...
# TODO: Your code here
# HW for Thursday, run this code and see what happens!
...
# Hint2: You can access the variable like this: ds[var] and you can get its
# attributes with the .attrs property
...
ds_subset = ds.isel(lat=slice(0, 30), lon=slice(20, 40))
...
spatial_mean_ds = ds_subset.mean(dim=['lat', 'lon'])
...
# TODO: Your code here
correlation = xr.corr(coarse_ds['potential_evapotranspiration'],
