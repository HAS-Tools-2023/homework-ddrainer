...
monthly_data = data['2023-10-01':'2023-11-05']
last_week = data['2023-10-29':'2023-11-04']
last_4weeks = data['2023-10-08':'2023-11-04']
...
week1_fcst = int(oct_means - (monthly_data.loc['2023-10-28', 'flow']) +
                 last_week_avg*0.85)
week2_fcst = int(nov_means - (monthly_data.loc['2023-10-28', 'flow']) +
                 last_4weeks_avg*0.50)

# Plot Data with Avg comapred to observed flow
fix, ax = plt.subplots()
ax.plot(monthly_data['flow'], color='orange',
        label='Observed Flow')
ax.plot(wmean_flow['2023-10-01':'2023-11-05'], color='gray',
        label='Weekly Mean')
...
ax.set(title="Observed Flow", xlabel="Date", ylabel="Flow[cfs]")
